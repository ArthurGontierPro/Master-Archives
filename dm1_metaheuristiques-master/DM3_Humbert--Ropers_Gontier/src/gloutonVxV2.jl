...
# Glouton Intelligent : choisissant une variable avec un coût intéressant

# =========================================================================== #

# Calcul des poids et tri des indices
...
# Fonction gloutonne, avec tri des indices solon les coûts, qui donne une solution admissible
